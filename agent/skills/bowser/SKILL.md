...
## Need more Playwright CLI context?

If you need deeper command coverage, advanced examples, or reference material for Playwright CLI, see the global skill:

- `/home/perazzojoao/.pi/agent/skills/playwright-cli/SKILL.md`
